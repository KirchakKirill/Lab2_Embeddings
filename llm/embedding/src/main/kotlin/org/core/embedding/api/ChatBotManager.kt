...
interface ChatBotManager {
    suspend fun generateChatMessage(url: String, chatHistory: MutableList<MessageData>, model: String, tools: List<ToolData> = listOf(), think: String): HttpResponse<String>?
